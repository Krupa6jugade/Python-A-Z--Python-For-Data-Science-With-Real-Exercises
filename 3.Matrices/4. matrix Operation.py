...
print(Pdict['JoeJohnson'])
print(Sdict['2009'])
print(Salary[2][4])

print(Salary[Pdict['JoeJohnson']][Sdict['2009']])
...
#print(round(FieldGoals/Games))  # get a Error

print("Use of round Function !")
print(np.matrix.round(FieldGoals/Games))

#
print("Change data  in to round !")

change = np.matrix.round(FieldGoals/Games)


print(change[Pdict['JoeJohnson']][Sdict['2009']])
