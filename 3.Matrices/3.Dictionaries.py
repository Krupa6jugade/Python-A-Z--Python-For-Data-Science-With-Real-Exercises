...
dit1 = {"one":"data one ","sec":"data sec","last":"last data"}

print(dit1["one"])



dit2 = {'alwar':'many time','jaipur':10,'delhi':True}
...
print(Pdict['KevinDurant'])

print(Games[7])

print(Games[Pdict['KevinDurant']])

print(Games[Pdict['KevinDurant']][7])

print(Games[Pdict['KevinDurant']][[Sdict['2012']]])

print(Points[Pdict['KevinDurant']][[Sdict['2012']]])
